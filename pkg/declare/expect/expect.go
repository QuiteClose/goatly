...
// Any will call t.Errorf unless any item from sub-set b is in a
...
// Contains will call t.Errorf unless a contains b (sub-set b is in a)
...
// Empty will call t.Errorf unless the string or slice is empty
...
// LongerThan will call t.Errorf unless the length of the string or slice is greater than n
...
// NotAny will call t.Errorf unless no item from sub-set b is in a
...
// NotContains will call t.Errorf unless a does not contain b (sub-set b is not in a)
...
// NotEmpty will call t.Errorf unless the string or slice is not empty
...
// ShorterThan will call t.Errorf unless the length of the string or slice is less than n
